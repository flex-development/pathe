...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/pathe
   cd pathe
   ```
...
```sh
https://github.com/flex-development/pathe/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/pathe/discussions/new?category=q-a
